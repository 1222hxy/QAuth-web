...
const I18N = {
  ...
  en: {
    ...
    heroTitle1: "Bring sign-in back to",
    heroTitle2: "trusted devices",
    heroDesc: "QAuth is a reusable identity engine for passwordless, device-driven sign-in. Your users see your product brand while QAuth handles secure authentication.",
    openFlow: "Explore capabilities",
    lang: "Language",
    theme: "Theme",
    light: "Light",
    dark: "Dark",
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4">
          <a href="#top" className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-[11px] text-slate-500">{I18N[lang].currentLang}</div>
            </div>
          </a>
          ...
          <div className="border-t border-slate-200 bg-white px-5 py-4 md:hidden">
            <div className="flex flex-col gap-3">
              ...
              <div className="grid grid-cols-2 gap-2">
                <select value={lang} onChange={(e) => setLang(e.target.value)} className="rounded-xl border border-slate-300 bg-white px-3 py-2 text-sm text-slate-800">
                  <option value="zh">中文</option><option value="en">English</option>
                </select>
                <button onClick={() => setTheme(theme === "dark" ? "light" : "dark")} className="rounded-xl border border-slate-300 bg-white px-3 py-2 text-sm text-slate-800">{I18N[lang].theme}: {theme === "dark" ? I18N[lang].dark : I18N[lang].light}</button>
              </div>
          ...
          <div className="relative mx-auto grid max-w-7xl items-center gap-14 lg:grid-cols-[1.05fr_0.95fr]">
            <div>
              ...
              <h1 className="max-w-4xl text-5xl font-black leading-tight tracking-tight md:text-7xl">
                {I18N[lang].heroTitle1}
                <span className="block bg-gradient-to-r from-sky-200 via-white to-indigo-200 bg-clip-text text-transparent">{I18N[lang].heroTitle2}</span>
              </h1>
